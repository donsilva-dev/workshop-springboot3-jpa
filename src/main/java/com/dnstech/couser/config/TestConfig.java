...
import com.dnstech.couser.entities.Payment;
import com.dnstech.couser.entities.Product;
import com.dnstech.couser.entities.User;
import com.dnstech.couser.entities.enuns.OrderStatus;
import com.dnstech.couser.repositories.CategoryRepository;
import com.dnstech.couser.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.DELIVERD, u1);
